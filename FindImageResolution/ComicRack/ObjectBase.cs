...
namespace FindImageResolution.ComicRack
{
    public class ObjectBase
    {
        ...
        public object InvokeMethod(string Method, params object[] param) => Object.InvokeMethod(Method, param);
        public IEnumerable<T> InvokeMethod<T>(string Method, params object[] param) where T : class
        {
            var enumerable = Object.InvokeMethod(Method, param) as IEnumerable;
